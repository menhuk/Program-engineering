        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Secondary_genre_id = table.Column<int>(type: "int", nullable: false),
                    Tertiary_genre_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    coverage_name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    borrowed_id = table.Column<int>(type: "int", nullable: false),
                    book_id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rent_Logs", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "430ed889-7597-4d99-9039-b062e25715aa", null, "User", "USER" },
                    { "b418e96f-28ed-451c-aeed-8e41890b3860", null, "Admin", "ADMIN" }
                });
